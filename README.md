# Tokenizer [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0)[![Go.Dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/alkuma/tokenizer?tab=doc)[![Travis CI](https://api.travis-ci.org/alkuma/tokenizer.svg?branch=master)](https://travis-ci.org/alkuma/tokenizer)[![Go Report Card](https://goreportcard.com/badge/github.com/alkuma/tokenizer)](https://goreportcard.com/report/github.com/alkuma/tokenizer) 
...
`tokenizer` is part of an ambitious goal (together with [**transformer**](https://github.com/alkuma/transformer) and [**gotch**](https://github.com/alkuma/gotch)) to bring more AI/deep-learning tools to Gophers so that they can stick to the language they love and build faster software in production. 
...
All models can be loaded from files manually. [pkg.go.dev](https://pkg.go.dev/github.com/alkuma/tokenizer?tab=doc) for detail APIs.


## Getting Started

- See [pkg.go.dev](https://pkg.go.dev/github.com/alkuma/tokenizer?tab=doc) for detail APIs 
